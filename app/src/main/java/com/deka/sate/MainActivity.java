...
import com.deka.sate.fragments.SateDetailFragment;
import com.deka.sate.fragments.SateMenuFragment;

public class MainActivity extends AppCompatActivity  implements SateMenuFragment.OnItemSelectedListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      SateMenuFragment firstFragment = new SateMenuFragment();
    ...
    if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
      SateDetailFragment secondFragment = new SateDetailFragment();
